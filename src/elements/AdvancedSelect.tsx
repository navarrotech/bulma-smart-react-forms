...
/*
 * This is a custom dropdown component that allows for more advanced features
 *   > Searching
 *   > Multi-select
...
export function AdvancedSelect({
  ...
  }, [ dropdownRef.current, filteredOptions, selectedIndex, handleSelect ])
        ...
        <div className='dropdown-content'>
          ...
          <div className='dropdown-wrapper'>
            {filteredOptions.map((option, index) => {
              ...
              const cls = `dropdown-item is-clickable ${
